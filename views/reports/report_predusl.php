...
<div class="container-fluid row" style="margin-top: 70px;margin-bottom: 50px;">
    <h1>Отчет по предстоящим услугам</h1>
    <div class="col">
        <div class="col"></div>
        <div class="col">


            <?= Html::beginForm(['reports/report_predusl_form', 'id' => 'otchet', 'name'=>'form1'], 'GET'); ?>
            ...
            <div class="form-group">
                ...
                <div style="display: flex;">
                    ...
                    <?= Html::textInput('SECOND_DATE','',['class' => 'form-control','style'=>'width:200px', 'autocomplete'=>'0']); ?>
